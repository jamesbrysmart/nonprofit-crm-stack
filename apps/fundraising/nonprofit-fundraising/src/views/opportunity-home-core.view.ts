...
const OPPORTUNITY_HOME_CORE_FIELD_GROUP_UNIVERSAL_IDENTIFIER =
...
export default defineView({
  ...
  fieldGroups: [
    {
      universalIdentifier:
        OPPORTUNITY_HOME_CORE_FIELD_GROUP_UNIVERSAL_IDENTIFIER,
      name: 'Funding detail',
      position: 0,
      isVisible: true,
    },
  ...
  fields: [
    ...
    {
      universalIdentifier: '1a4618cb-dd62-4c0f-8bde-47c17b5f2d6e',
      fieldMetadataUniversalIdentifier:
