...
const config: ApplicationConfig = {
  ...
  description: 'Gift rollup engine',
  applicationVariables: {
    TWENTY_API_KEY: {
      ...
      value: '',
      description:
        'Workspace API key used by the rollup engine to call Twenty REST API endpoints.',
    },
    TWENTY_API_BASE_URL: {
      ...
      description:
        'REST base URL used by the rollup engine. Override to https://app.twenty.com/rest when deploying to a cloud workspace.',
    },
